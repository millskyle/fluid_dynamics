...
def x(x0,y0,t):
   return -0.25*exp(k*y0)*sin(k*x0 - w*t) - x0
#   return -exp(k*y1)*sin(k*x1 - w*t) - x1

def y(x0,y0,t):
   return 0.25*exp(k*y0)*cos(k*x0 - w*t) - y0
...
fig.savefig("fluid_element_parametrization.eps")
fig.savefig("fluid_element_parametrization.png")
